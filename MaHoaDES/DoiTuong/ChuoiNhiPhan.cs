...
namespace MaHoaDES.DoiTuong
{
    class ChuoiNhiPhan
    {
        ...
        /// <param name="chuoi2"></param>
        /// <returns></returns>
        public ChuoiNhiPhan Cong(ChuoiNhiPhan chuoi2, frmMaHoaDES.ProgressUpdateCallback progressUpdate = null, int totalBit = 0)
        {
            ChuoiNhiPhan ChuoiKQ = new ChuoiNhiPhan(chuoi2.DoDai + this.DoDai);

            // Sử dụng Array.Copy thay vì vòng lặp để sao chép dữ liệu
            Array.Copy(this.MangNhiPhan, 0, ChuoiKQ.MangNhiPhan, 0, this.DoDai);
            Array.Copy(chuoi2.MangNhiPhan, 0, ChuoiKQ.MangNhiPhan, this.DoDai, chuoi2.DoDai);
